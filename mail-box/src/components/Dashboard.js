  ...
  return (
    <div className="relative ml-32 flex m-10 space-x-5">
      <div className="w-[18%] mx-2 bg-gray-900 rounded-3xl bg-opacity-30 py-5 px-5">
        ...
        <button
          className="text-white my-2 w-full text-lg text-center p-2 border-2 rounded-full border-gray-500 hover:bg-gray-200 hover:bg-opacity-30"
          onClick={toggleInbox}
        >
          📥 Inbox
        </button>
        <button
          className="text-white w-full text-lg text-center p-2 border-2 rounded-full border-gray-500 hover:bg-gray-200 hover:bg-opacity-30"
